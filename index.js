...
console.log(`task 1b`, createMenuItem('Reuben', 10, 'Dinner'));
console.log(`task 1b`, createMenuItem('Egg Salad Sandwich', 9, 'Breakfast'));
console.log(`task 1b`, createMenuItem('Kids Turkey', 6, 'Lunch'));
